...
- Create: `infra/docker-compose.yml`, `infra/env/.env.example`, `infra/seaweedfs/s3.json.example`, `infra/postgres/init/01-roles.sql`
...
## Success Criteria
- [ ] Compose levanta los tres servicios healthy desde cero en < 2 min
