...
5. Tests: formularios sin violaciones de axe; crear rol con permisos no poseídos no es
   ...
   formulario de miembro cambia sus campos al cambiar el rol seleccionado.
6. Checklist de accesibilidad para las cuatro pantallas nuevas.
