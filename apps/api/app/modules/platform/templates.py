...
def registration_terms_template(branding: PlatformBranding, sitio: str) -> str:
    ...
    return (
        ...
        f"página del evento o puedes pedírselas a la organización antes de "
        f"inscribirte. Si contradicen estas condiciones generales, "
        f"prevalecen las de la organización.\n\n"
        f"**Datos aportados**\n\n"
