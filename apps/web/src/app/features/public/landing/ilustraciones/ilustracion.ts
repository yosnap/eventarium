  ...
  template: `
    @switch (tipo()) {
      @case ('inscripciones') {
        ...
        <div class="landing-capa landing-capa--linea" style="left: 22%; top: 40%; width: 40%"></div>
        <div class="landing-capa landing-capa--linea" style="left: 22%; top: 52%; width: 24%"></div>
        <div
      ...
      @case ('entradas') {
        ...
        ></div>
        <div class="landing-capa landing-capa--linea" style="left: 56%; top: 36%; width: 20%"></div>
        <div class="landing-capa landing-capa--linea" style="left: 56%; top: 46%; width: 14%"></div>
        <div
      ...
      @case ('marca') {
        <div class="landing-capa" style="inset: 14% 14% 20% 14%"></div>
        <div
          class="landing-capa landing-capa--acento"
        ...
        ></div>
        <div class="landing-capa landing-capa--linea" style="left: 42%; top: 38%; width: 34%"></div>
        <div class="landing-capa landing-capa--linea" style="left: 42%; top: 48%; width: 22%"></div>
        <div
      ...
      @case ('patrocinadores') {
        ...
        ></div>
        <div class="landing-capa" style="left: 50%; top: 18%; width: 18%; height: 22%"></div>
        <div class="landing-capa" style="left: 72%; top: 18%; width: 14%; height: 22%"></div>
        <div
          class="landing-capa landing-capa--suave"
        ...
        ></div>
        <div class="landing-capa landing-capa--linea" style="left: 14%; top: 74%; width: 72%"></div>
      }
      @case ('contabilidad') {
        <div class="landing-capa" style="inset: 14% 14% 14% 14%"></div>
        <div
          class="landing-capa landing-capa--suave"
      ...
      @case ('agenda') {
        <div class="landing-capa" style="inset: 14% 14% 14% 14%"></div>
        <div class="landing-capa landing-capa--linea" style="left: 20%; top: 26%; width: 12%"></div>
        <div
          class="landing-capa landing-capa--acento"
          style="left: 36%; top: 24%; width: 44%; height: 10%"
        ></div>
        <div class="landing-capa landing-capa--linea" style="left: 20%; top: 42%; width: 12%"></div>
        <div
          class="landing-capa landing-capa--suave"
          style="left: 36%; top: 40%; width: 30%; height: 10%"
        ></div>
        <div class="landing-capa landing-capa--linea" style="left: 20%; top: 58%; width: 12%"></div>
        <div
          class="landing-capa landing-capa--suave"
          style="left: 36%; top: 56%; width: 44%; height: 10%; border: 1px dashed var(--border-strong); background: transparent"
        ></div>
        <div class="landing-capa landing-capa--linea" style="left: 20%; top: 74%; width: 12%"></div>
        <div
          class="landing-capa landing-capa--acento"
      ...
      @case ('ponentes') {
        ...
        ></div>
        <div class="landing-capa" style="inset: 50% 16% 16% 16%"></div>
        <div class="landing-capa landing-capa--linea" style="left: 24%; top: 60%; width: 40%"></div>
        <div class="landing-capa landing-capa--linea" style="left: 24%; top: 70%; width: 52%"></div>
      }
      @case ('pagos') {
        <div
          class="landing-capa"
        ...
        ></div>
        <div class="landing-capa landing-capa--linea" style="left: 26%; top: 60%; width: 24%"></div>
        <div
          class="landing-capa landing-capa--suave"
